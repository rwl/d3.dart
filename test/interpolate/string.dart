...
void main() {
  group('interpolateString', () {
    var interpolate = load('interpolate/string').expression('d3.interpolateString');
    test('interpolates matching numbers in both strings', () {
      expect(interpolate(' 10/20 30', '50/10 100 ')(.2), same('18/18 44 '));
      expect(interpolate(' 10/20 30', '50/10 100 ')(.4), same('26/16 58 '));
    });
